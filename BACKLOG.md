...
| CR-10 | Register memory MCP in Codex and Gemini — Codex CLI installed + registered; Gemini API key configured + registered. Moved from memory-layer POST-05 | Setup | P2 | S | Done |
